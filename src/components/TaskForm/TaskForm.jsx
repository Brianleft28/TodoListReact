...
const TaskForm = ({onSubmit, title, description, setTitle, setDescription }) => {
  ...
  return (
   <form onSubmit={handleSubmit} className='flex flex-col gap-1 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 justify-center '>
      <label className='selection:bg-none  text-black font-bold'>Agregar una tarea</label>
      <hr className='mt-3'/>
